...
{	
	public static void main(String[] args) throws IOException, InvalidEmailException, InvalidPasswordException, UserAlreadySignedUpException
	{
		...
		Instructor i = new Instructor("Azzam","Mourad","azzam.mourad.@lau.edu", "321");
		Users.addUser(s1);
		Users.addUser(s2);
		Users.addUser(s3);
		Users.addUser(i);
		ArrayList<LauUser> lauUsers = Users.getUsers();
		System.out.println(lauUsers);
		boolean valid = Users.isValidUser(s1.getEmail()+"fdsfadfs", s1.getPassword()); 
		if (valid)
